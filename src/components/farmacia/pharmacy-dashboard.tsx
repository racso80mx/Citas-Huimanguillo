  ...
  const handleFileUpload = (event: React.ChangeEvent<HTMLInputElement>) => {
    ...
    startUploadTransition(async () => {
      ...
      try {
        ...
        toast({ title: 'Inventario actualizado con éxito' });
        loadMedications();
      } catch (error: any) {
        ...
        <TabsContent value="inventario" className="space-y-6 pt-6">
            <div className="grid md:grid-cols-3 gap-6">
                <Card className="md:col-span-1 shadow-sm border-primary/10">
                    <CardHeader>
                        <CardTitle className="text-lg">Cargar Inventario</CardTitle>
                    </CardHeader>
                        ...
                        <AlertDialog>
                            ...
                            <AlertDialogContent>
                                <AlertDialogHeader>
                                    ...
                                    <AlertDialogDescription>Esta acción eliminará todos los registros actuales de Farmacia.</AlertDialogDescription>
                                </AlertDialogHeader>
                                <AlertDialogFooter>
                                        ...
                                        filteredAndSortedMedications.slice(0, 500).map((med) => {
                                            ...
                                            return (
                                                <TableRow key={med.id} className="hover:bg-muted/30">
                                                    ...
                                                    <TableCell className="text-[11px] font-medium uppercase leading-tight">{med.descripcion}</TableCell>
                                                    <TableCell className="text-right">
                                                        <Badge variant={med.existencia > 0 ? 'secondary' : 'destructive'} className="font-black">{med.existencia}</Badge>
                                                    </TableCell>
                                                    <TableCell>
                                                        <Badge 
                                                            variant="outline"
