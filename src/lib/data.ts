...
export async function getPatientsData(options?: any): Promise<Patient[]> {
    ...
    // Búsqueda directa por CURP (Alta prioridad)
...
/**
 * SCRIPT MASIVO: Genera el campo nombreCompleto para todos los pacientes.
 */
